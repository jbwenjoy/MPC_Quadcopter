...
mpc1.OV(1).ScaleFactor = 1000; % x
mpc1.OV(2).ScaleFactor = 10; % vx
mpc1.OV(3).ScaleFactor = 1000; % y
mpc1.OV(4).ScaleFactor = 10; % vy
mpc1.OV(5).ScaleFactor = 100; % z
mpc1.OV(6).ScaleFactor = 10; % vz
...
mpc1.Weights.OV = [10 0 10 0 100 0 0 0 0 0 5 1];
